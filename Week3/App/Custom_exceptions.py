...
class InvalidInputError(TaskManagerException):
    def __init__(self, field_name: str, value: str, reason: str):
        self.message = f"Valoare invalida pentru campul '{field_name}': '{value}'. Motiv: {reason}"
        super().__init__(self.message)

class TaskNotFoundError(TaskManagerException):
    def __init__(self, task_id: int):
        self.message = f"Eroare: Task-ul cu ID-ul {task_id} nu a fost gasit in baza de date."
        super().__init__(self.message)
